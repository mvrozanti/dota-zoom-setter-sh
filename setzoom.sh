#!/bin/bash
DEFAULT_STEAM_CLIENT_PATH='/home/nexor/.steam/steam/steamapps/common/dota 2 beta/game/dota/bin/linuxsteamrt64/libclient.so'
if [ -f "$DIRECTORY" ]; then echo Located default client path; else echo "Could not find default dota 2 client path"; exit 1; fi
